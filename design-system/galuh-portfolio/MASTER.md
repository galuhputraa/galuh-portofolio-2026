...
> **⚠ PALETTE + TYPE OVERRIDE — read this first.**
> This file is generator output. Its **colour and font tables are NOT what this
> site uses.** The generator proposed monochrome + blue `#2563EB` with Inter;
> the site instead inherits the slate/teal palette and the Plus Jakarta Sans /
> IBM Plex Mono / Great Vibes stack from the previous portfolio HTML.
>
> **The authoritative tokens live in [`app/globals.css`](../../app/globals.css).**
> Light (default): `--bg #EEF1F6` · `--surface #FFFFFF` · `--fg #1E2A44` ·
> `--accent #0F6F6A` · `--pill #2B374D`.
> Dark: `--bg #080B12` · `--surface #0F1420` · `--fg #E8ECF4` · `--accent #2DD4BF`.
>
> Everything else below (pattern, style, layout, motion tier, anti-patterns,
> checklist) **does** describe the built site.
...
**Project:** Galuh Portfolio
**Generated:** 2026-08-03 18:41:16
